        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                if (null != entity) {
                    ...
                    callback = JSON.parseObject(responseMsg, RemoteCallBack.class);
                    if (callback == null) {
            ...
            e.printStackTrace();
            /*
             * StringWriter out = new StringWriter(); e.printStackTrace(new PrintWriter(out)); callback.setMsg(out.toString());
             */
